...
const About = () => {
  return (
    <section className="my-4 p-4 bg-white w-full mx-auto">
      <div className="w-full">
        <div className="box-container">
          <h2 className="text-4xl font-normal mb-4">HI, I'M ALEX!</h2>
        </div>
        <div className="content-container flex">
          <div className="text-container">
            ...
            <p className="mb-4">
            Prior to transitioning into tech, I spent years in program management and client-facing roles, leading high-performance teams and driving revenue growth. As a Program Manager with EXOS at Google, I spearheaded initiatives that expanded client engagement by 30%, hired and managed a team of 50+ employees, and delivered key business objectives in a fast-paced, high-stakes environment. My experience as a real estate professional further strengthened my ability to navigate complex negotiations, analyze market trends, and provide data-driven solutions—skills that now enhance my approach to solving technical and business challenges.
            </p>
            <p className="mb-4">
